<template>
  ...
  >
    <div class="container">
      ...
      <div class="placeholder" v-else>選取圖片、文字或含文字的圖形，標註類型</div>
    </div>
  </MoveablePanel>
</template>
