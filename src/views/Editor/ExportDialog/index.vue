...
const tabs: TabItem[] = [
  { key: 'llmslide', label: '匯出為 .llmslide 專案檔' },
  { key: 'pptx', label: '匯出為 PowerPoint' },
  { key: 'image', label: '匯出為圖片' },
  { key: 'json', label: '匯出為 JSON 資料' },
  { key: 'pdf', label: '列印或匯出為 PDF' },
]
