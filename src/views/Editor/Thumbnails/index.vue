<template>
  ...
  >
    ...
    ></div>
    <div class="add-slide">
      <div class="btn" @click="createSlide()"><IconPlus class="icon" />新增投影片</div>
        ...
        <div class="thumbnail-container">
          ...
          >
            ...
            <span class="text" v-else>
              <div class="text-content">{{ element?.sectionTag ? (element?.sectionTag?.title || '未命名的章節') : '預設章節' }}</div>
            </span>
          </div>
          <div
          ...
          >
            ...
            <ThumbnailSlide class="thumbnail" :slide="element" :size='newWidth/1.4' :visible="index < slidesLoadLimit" />
...
const resize = (e: MouseEvent) => {
  ...
  document.onmousemove = e => {
    ...
    const moveX = startPageX -currentPageX  
    newWidth.value = originWidth - moveX

    if (newWidth.value < 180) newWidth.value = 180
    if (newWidth.value > 360) newWidth.value = 360
    emit('update:width', newWidth.value)
  }
