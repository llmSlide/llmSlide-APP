<template>
  <div class="multi-style-panel">
    ...
    >
      <RadioButton value="left" style="flex: 1;" v-tooltip="'靠左對齊'"><IconAlignTextLeft /></RadioButton>
      <RadioButton value="center" style="flex: 1;" v-tooltip="'置中'"><IconAlignTextCenter /></RadioButton>
      <RadioButton value="right" style="flex: 1;" v-tooltip="'靠右對齊'"><IconAlignTextRight /></RadioButton>
      <RadioButton value="justify" style="flex: 1;" v-tooltip="'兩端對齊'"><IconAlignTextBoth /></RadioButton>
    </RadioGroup>
  </div>
</template>
