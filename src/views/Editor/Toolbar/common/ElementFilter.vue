...
const defaultFilters: FilterOption[] = [
  ...
  { label: '灰階', key: 'grayscale', default: 0, value: 0, unit: '%', max: 100, step: 5 },
  ...
  { label: '褐色調', key: 'sepia', default: 0, value: 0, unit: '%', max: 100, step: 5 },
  { label: '反相', key: 'invert', default: 0, value: 0, unit: '%', max: 100, step: 5 },
