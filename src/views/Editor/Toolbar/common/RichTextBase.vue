  ...
  <div class="rich-text-base">
    ...
    <ButtonGroup class="row" passive>
      ...
      <Popover trigger="click" style="width: 30%;">
        ...
        <TextColorButton v-tooltip="'文字醒目提示色彩'" :color="richTextAttrs.backcolor">
          <IconHighLight />
        </TextColorButton>
      </Popover>
      <Button 
        ...
        <template #content>
          <div class="link-popover">
            ...
            <div class="btns">
              ...
              <Button size="small" type="primary" @click="updateLink(link)">確定</Button>
            </div>
          </div>
        </template>
        <CheckboxButton
    ...
    >
      <RadioButton value="left" v-tooltip="'靠左對齊'" style="flex: 1;"><IconAlignTextLeft /></RadioButton>
      <RadioButton value="center" v-tooltip="'置中對齊'" style="flex: 1;"><IconAlignTextCenter /></RadioButton>
      <RadioButton value="right" v-tooltip="'靠右對齊'" style="flex: 1;"><IconAlignTextRight /></RadioButton>
      <RadioButton value="justify" v-tooltip="'左右對齊'" style="flex: 1;"><IconAlignTextBoth /></RadioButton>
    </RadioGroup>
    ...
    <div class="row">
      <ButtonGroup style="flex: 1;" passive>
        <Button first style="flex: 1;" v-tooltip="'減少清單階層'" @click="emitRichTextCommand('indent', '-1')"><IconIndentLeft /></Button>
        <Popover trigger="click" v-model:value="indentLeftPanelVisible">
          <template #content>
            <PopoverMenuItem @click="emitRichTextCommand('textIndent', '-1')">減少首行階層</PopoverMenuItem>
          </template>
          <Button last class="popover-btn"><IconDown /></Button>
        </Popover>
      </ButtonGroup>
      <div style="width: 10px;"></div>
      <ButtonGroup style="flex: 1;" passive>
        <Button first style="flex: 1;" v-tooltip="'增加清單階層'" @click="emitRichTextCommand('indent', '+1')"><IconIndentRight /></Button>
        <Popover trigger="click" v-model:value="indentRightPanelVisible">
          <template #content>
            <PopoverMenuItem @click="emitRichTextCommand('textIndent', '+1')">增加首行階層</PopoverMenuItem>
          </template>
          <Button last class="popover-btn"><IconDown /></Button>
        </Popover>
      </ButtonGroup>
...
const updateLink = (link?: string) => {
  ...
  if (!link || !linkRegExp.test(link)) return message.error('非正確網址連結')
