<template>
  <div class="chart-style-panel">
    ...
    >
      <ThemeColorsSetting :colors="themeColors" @update="(colors: string[]) => setThemeColors(colors)" />
    </Modal>
  </div>
</template>
