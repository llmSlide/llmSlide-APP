  ...
  <div class="shape-style-panel">
    ...
    <div class="row">
      <Select 
        ...
        :options="[
          { label: '實心填滿', value: 'fill' },
          { label: '漸層填滿', value: 'gradient' },
          { label: '圖片填滿', value: 'pattern' },
        ]"
      />
    ...
    <template v-if="handleShapeElement.text?.content">
      ...
      >
        <RadioButton value="top" v-tooltip="'頂端對齊'" style="flex: 1;"><IconAlignTextTopOne /></RadioButton>
        <RadioButton value="middle" v-tooltip="'置中對齊'" style="flex: 1;"><IconAlignTextMiddleOne /></RadioButton>
        <RadioButton value="bottom" v-tooltip="'底端對齊'" style="flex: 1;"><IconAlignTextBottomOne /></RadioButton>
      </RadioGroup>
    ...
    <div class="row">
      ...
      ><IconFormatBrush /> 複製格式</CheckboxButton>
    </div>
  </div>
</template>
