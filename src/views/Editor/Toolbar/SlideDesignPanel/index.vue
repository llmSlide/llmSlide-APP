  ...
  <div class="slide-design-panel">
    ...
    <div class="row">
      <Select 
        ...
        :options="[
          { label: '實心填滿', value: 'solid' },
          { label: '圖片填滿', value: 'image' },
          { label: '漸變填滿', value: 'gradient' },
        ]"
      />
      ...
      <Select 
        ...
        :options="[
          ...
          { label: '平鋪', value: 'repeat' },
          { label: '填滿', value: 'cover' },
        ]"
      />
      ...
      <Select 
        ...
        v-else
        :options="[
          { label: '線性漸層', value: 'linear' },
          { label: '放射狀漸層', value: 'radial' },
        ]"
      />
    </div>
    ...
    <div class="row">
      <Button style="flex: 1;" @click="applyBackgroundAllSlide()">套用背景到全部</Button>
    </div>
    ...
    <div class="row">
      <Select 
        ...
        :options="[
          { label: '寬螢幕 16 : 9', value: 0.5625 },
          { label: '寬螢幕 16 : 10', value: 0.625 },
          { label: '標準 4 : 3', value: 0.75 },
          { label: '橫向 A3 / A4', value: 0.70710678 },
          { label: '直向 A3 / A4', value: 1.41421356 },
        ]"
      />
    </div>

    <div class="row">
      <div class="canvas-size">投影片大小：{{  viewportSize  }} × {{ toFixed(viewportSize * viewportRatio) }}</div>
    </div>
    ...
    <div class="row">
      <Button style="flex: 1;" @click="applyThemeToAllSlides(moreThemeConfigsVisible)">套用主題到全部</Button>
    </div>

    <div class="row">
      <Button style="flex: 1;" @click="themeStylesExtractVisible = true">從投影片擷取主題</Button>
    </div>

    <Divider />

    <div class="title">預設主題</div>
    <div class="theme-list">
      ...
      >
        <div class="theme-item-content">
          ...
          <div class="btns">
            <Button type="primary" size="small" @click="applyPresetTheme(item)">設置</Button>
            <Button type="primary" size="small" style="margin-top: 3px;" @click="applyPresetTheme(item, true)">設置並套用</Button>
          </div>
        </div>
      </div>
    </div>
